...
```bash
python3 claude/scripts/check-codex-drift.py              # report drift (Codex + lane persona body)
python3 claude/scripts/check-codex-drift.py --verbose    # report + unified diff
python3 claude/scripts/check-codex-drift.py --sync       # rewrite Codex sections from canonical (persona body NOT auto-synced in v1)
```
