...
1. If the soldier is debating whether to fix or report the same issue, I force classification: tactical means fix then report; strategic means report before fixing; missing fact means bounded evidence then reclassify.
...
**When a soldier second-guesses tactical work,** I do not answer "maybe." I give a classification order: fix tactical friction, gather a missing local fact, or stop on strategic ambiguity. The soldier does not both fix and escalate the same issue.
